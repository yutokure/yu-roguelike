    ...
    "tools": {
      "sidebar": {
        ...
        "stateManager": {
          ...
          "panelAriaLabel": "状態管理ツール",
          "header": {
            "title": "状態管理",
            "description": "ダンジョン探索の進行状況やMiniExp、BlockDimの履歴、ツールズタブ各ツールのデータを一括でバックアップ／復元します。"
          },
          "body": {
            "description": "「全体エクスポート」で現在の状態を1つのJSONファイルとして保存し、「全体インポート」でそのファイルを読み込むと完全に復元できます。"
          },
          "actions": {
            "export": "全体エクスポート",
            "import": "全体インポート"
    ...
    "games": {
      ...
      "treasureHunt": {
        "ui": {
          ...
          "pause": "一時停止",
          "hint": "WASD/矢印で移動。宝箱と自分の距離が遠いほど基礎EXPが増え、素早く拾うほど倍率が上がります。",
          "hintNoMap": "WASD/矢印で移動。宝箱と自分の距離が遠いほど基礎EXPが増えます。NORMAL以上ではマップが非表示なのでステータスのヒントを頼りに探索しましょう。"
        },
        "labels": {
          "round": "ラウンド: {value}",
          "time": "タイム: {value}",
