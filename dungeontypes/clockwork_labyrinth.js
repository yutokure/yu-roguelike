...
(function(){
  ...
  const gen = {
    ...
    name: '機構迷宮',
    nameKey: "dungeon.types.clockwork_labyrinth.name",
    description: '歯車のような同心回廊が広がる機械仕掛けの迷宮',
    descriptionKey: "dungeon.types.clockwork_labyrinth.description",
    algorithm,
    ...
    blocks1:[
      {
        key:'clock_theme_01',
        name:'Clock Theme I',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.clock_theme_01.name",
        level:+0,
        size:0,
        depth:+1,
        chest:'normal',
        type:'clockwork-labyrinth',
        bossFloors:mkBoss(6)
      },
      {
        key:'clock_theme_02',
        name:'Clock Theme II',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.clock_theme_02.name",
        level:+8,
        size:+1,
        depth:+1,
        chest:'less',
      ...
      },
      {
        ...
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.clock_theme_03.name",
        level:+16,
        size:+1,
        depth:+2,
        chest:'more',
      ...
      },
      {
        key:'clock_theme_04',
        name:'Clock Theme IV',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.clock_theme_04.name",
        level:+24,
        size:+2,
        depth:+2,
        chest:'normal',
      ...
      },
      {
        key:'clock_theme_05',
        name:'Clock Theme V',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.clock_theme_05.name",
        level:+32,
        size:+2,
        depth:+3,
        chest:'less',
    ...
    blocks2:[
      {
        key:'gear_core_01',
        name:'Gear Core I',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_core_01.name",
        level:+0,
        size:+1,
        depth:0,
        chest:'normal',
      ...
      },
      {
        key:'gear_core_02',
        name:'Gear Core II',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_core_02.name",
        level:+6,
        size:+1,
        depth:+1,
        chest:'more',
      ...
      },
      {
        key:'gear_core_03',
        name:'Gear Core III',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_core_03.name",
        level:+12,
        size:+2,
        depth:+1,
        chest:'less',
      ...
      },
      {
        key:'gear_core_04',
        name:'Gear Core IV',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_core_04.name",
        level:+18,
        size:+2,
        depth:+2,
        chest:'normal',
      ...
      },
      {
        key:'gear_core_05',
        name:'Gear Core V',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_core_05.name",
        level:+24,
        size:+3,
        depth:+2,
        chest:'more',
    ...
    blocks3:[
      {
        key:'gear_relic_01',
        name:'Gear Relic I',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_relic_01.name",
        level:+0,
        size:0,
        depth:+2,
        chest:'more',
      ...
      },
      {
        key:'gear_relic_02',
        name:'Gear Relic II',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_relic_02.name",
        level:+9,
        size:+1,
        depth:+2,
        chest:'normal',
      ...
      },
      {
        key:'gear_relic_03',
        name:'Gear Relic III',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_relic_03.name",
        level:+18,
        size:+1,
        depth:+3,
        chest:'less',
      ...
      },
      {
        key:'gear_relic_04',
        name:'Gear Relic IV',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_relic_04.name",
        level:+24,
        size:+2,
        depth:+3,
        chest:'more',
      ...
      },
      {
        key:'gear_relic_05',
        name:'Gear Relic V',
        nameKey: "dungeon.types.clockwork_labyrinth.blocks.gear_relic_05.name",
        level:+30,
        size:+2,
        depth:+4,
        chest:'normal',
