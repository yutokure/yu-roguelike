document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ja: {
            'meta.title': 'Yuローグライク | 456種のダンジョン生成とMiniExp 75種搭載のオープンソースローグライク',
            'meta.description': 'Yuローグライクは456種類の自動生成アルゴリズムと75種類のMiniExpミニゲームを搭載したMITライセンスのローグライク。ブラウザで冒険を設計し、GitHubで共同開発できます。',
            'meta.ogTitle': 'Yuローグライク | 456種のダンジョン生成とMiniExp 75種搭載のオープンソースローグライク',
            'meta.ogDescription': '自動生成アルゴリズム456種とMiniExp 75種を収録したMITライセンスのYuローグライク。ブラウザで冒険を作り、GitHubでコミュニティと共創できます。',
            'meta.twitterTitle': 'Yuローグライク | 456種の自動生成を備えたオープンソースローグライク',
            'meta.twitterDescription': 'ブラウザで冒険を構築できるYuローグライク。456種のダンジョン生成と75種のMiniExpミニゲームをMITライセンスで公開中。',
            ...
            'nav.manual': 'マニュアル',
            'nav.toggle': 'メニューを開く',
            'hero.eyebrow': '456の生成アルゴリズム × 75種のミニゲーム',
            'hero.title': 'Yuローグライクで、無限の冒険をデザインしよう',
            'hero.lead': '456種類のダンジョン生成アルゴリズムと、経験値に直結する75種類の高品質ミニゲーム。サンドボックスモードとパッシブの玉システムで、あなたのビルドを自由に磨き上げましょう。',
            'hero.primaryCta': 'デモを起動',
            'hero.secondaryCta': '特徴を見る',
            'hero.githubCta': 'GitHubで貢献する',
            'hero.contribute': 'Yuローグライクは既に公開・リリース済みのオープンソースです。GitHubでのIssue作成やPull Requestでの貢献を歓迎しています。',
            ...
            'hero.meta.licenseValue': 'MIT（GitHub公開中）',
            'hero.cardDungeon.title': 'Procedural Mastery',
            'hero.cardDungeon.body': '456通りに広がるフロアと遭遇。',
            ...
            'flow.step1.body': '456種類の生成アルゴリズムと推奨レベルを比較し、挑む世界と報酬テーブルを決定します。',
            ...
            'flow.step3.body': '75種の高品質ミニゲームに挑戦し、スコアをそのまま冒険者の経験値や資源に変換します。',
            ...
            'persona.body': 'オープンなMITライセンスで公開中のプロジェクトだからこそ、ゲーム制作・学習・コミュニティ共有に幅広く活用できます。',
            ...
            'persona.card2.point1': '456種アルゴリズムの比較・分析に最適',
            ...
            'minigame.body': '75種類の高品質ミニゲームと制作ユーティリティから、代表的なコンテンツをピックアップしました。',
            'carousel.prev': '前へ',
            'carousel.next': '次へ',
            ...
            'manual.card4.body': '75種類のMiniExpラインナップと制作ツールの特徴をチェック。',
            'manual.cta': 'オンラインマニュアルを開く',
            'cta.heading': 'オープンな冒険を、今すぐ設計しよう',
            'cta.body': 'MITライセンスでGitHub公開中。ダンジョン生成・MiniExp・サンドボックスを組み合わせて、自分だけのローグライクを世界にシェアできます。',
            'cta.primary': 'ゲームを起動',
            'cta.secondary': '導入ガイドを見る',
            'footer.copy': '© 2024 Yuローグライク Project. MITライセンスで公開中。',
            'scrollTop.label': 'ページ上部に戻る'
        },
        en: {
            'meta.title': 'Yu Roguelike | Open-Source Roguelike with 456 Generators & 75 MiniExp Games',
            'meta.description': 'Yu Roguelike combines 456 procedural generation algorithms and 75 MiniExp mini-games under the MIT license. Design adventures in the browser and collaborate on GitHub.',
            'meta.ogTitle': 'Yu Roguelike | Open-Source Roguelike with 456 Generators & 75 MiniExp Games',
            'meta.ogDescription': 'Build browser-based adventures with 456 procedural dungeon algorithms and 75 MiniExp mini-games. Yu Roguelike is MIT licensed and ready for GitHub collaboration.',
            'meta.twitterTitle': 'Yu Roguelike | 456 Procedural Generators + 75 MiniExp Mini-Games',
            'meta.twitterDescription': 'Design, play, and contribute to Yu Roguelike — an MIT-licensed roguelike packing 456 dungeon generators and 75 MiniExp experiences.',
            ...
            'hero.eyebrow': '456 Generation Algorithms × 75 Premium Mini-Games',
            'hero.title': 'Design Infinite Adventures with Yu Roguelike',
            'hero.lead': 'Harness 456 unique dungeon generators and 75 premium mini-games that convert scores into experience. Sandbox mode and the passive orb system let you perfect every build.',
            'hero.primaryCta': 'Launch Demo',
            'hero.secondaryCta': 'Explore Features',
            'hero.githubCta': 'Contribute on GitHub',
            'hero.contribute': 'Yu Roguelike is already live and open-sourced. Issues and pull requests on GitHub are warmly welcomed.',
            ...
            'hero.meta.licenseValue': 'MIT (available on GitHub)',
            'hero.cardDungeon.title': 'Procedural Mastery',
            'hero.cardDungeon.body': 'Encounter floors shaped by 456 blueprints.',
            'hero.cardSkill.title': 'Passive Orbs',
            ...
            'flow.step1.body': 'Review 456 algorithms and recommended levels to pick your challenge and rewards.',
            ...
            'flow.step3.body': 'Tackle 75 premium mini-games and convert high scores directly into experience and resources.',
            ...
            'persona.body': 'With an MIT release now available, Yu Roguelike is ideal for development, education, and community sharing.',
            ...
            'persona.card2.point1': 'Perfect for analysing all 456 algorithms',
            ...
            'minigame.body': 'Explore standout entries from the 75-piece high-quality MiniExp and utility collection.',
            ...
            'cta.body': 'The project is available on GitHub under MIT. Combine dungeon generators, MiniExp, and sandbox systems to share your own roguelike.',
            'cta.primary': 'Launch Game',
            'cta.secondary': 'Read the Onboarding Guide',
            'footer.copy': '© 2024 Yu Roguelike Project. MIT License.',
