...
'持ち駒と成りを駆使する本格将棋。指し手/捕獲/王手でEXP', category: 'ボード' },
  { id: 'riichi_mahjong', name: 'リーチ麻雀ライト', entry: 'games/mahjong.js', version: '0.1.0', author: 'mod', description:
'AI3人と東風1局を戦う簡易リーチ麻雀。リーチ/ツモ/ロンと点棒精算に対応', category: 'ボード' },
  ...
  { id: 'mancala',     name: 'マンカラ',        entry: 'games/mancala.js',      version: '0.1.0', author: 'mod', description: 'カラハ式マンカラ。種まきと捕獲を駆使してAIと勝負', category: 'ボード' },
  ...
  { id: 'sugoroku_life', name: '人生すごろく', entry: 'games/sugoroku_life.js', version: '0.1.0', author: 'mod', description: 'キャリアイベントを乗り越えて資産とEXPを伸ばす人生風すごろく', category: 'ボード' },
  ...
  { id: 'login_bonus', name: 'ログインボーナス',   entry: 'games/login_bonus.js', version: '0.1.0', author: 'mod', description: 'カレンダーで毎日のログインボーナスを受け取り記録できます', category: 'ユーティリティ' },
  ...
  { id: 'bowling_duel',  name: 'ボウリング対決',     entry: 'games/bowling.js',         version: '0.1.0', author: 'mod', description: 'カーブ・狙い・パワーを調整してCPUと10フレーム勝負するボウリングMOD', category: 'アクション' },
  ...
  { id: 'populite',    name: 'ポピュラス風',     entry: 'games/populite.js',     version: '0.1.0', author: 'mod', description: '地形整備と信仰力で人口目標を達成するリアルタイム神シミュレーション', category: 'シミュレーション' },
