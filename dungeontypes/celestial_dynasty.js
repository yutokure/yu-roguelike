(function(){
  ...
  const generators = [
    {
      ...
      name: '紫禁庭苑',
      nameKey: "dungeon.types.imperial_courtyard.name",
      description: '王宮の中庭が重なる儀礼空間',
      descriptionKey: "dungeon.types.imperial_courtyard.description",
    ...
    },
    {
      id: 'lotus-labyrinth',
      name: '蓮花迷宮',
      nameKey: "dungeon.types.lotus_labyrinth.name",
      description: '蓮が幾重にも咲く輪郭状の迷宮',
      descriptionKey: "dungeon.types.lotus_labyrinth.description",
    ...
    },
    {
      id: 'silk-market',
      name: '絲綢市集',
      nameKey: "dungeon.types.silk_market.name",
      description: '縦横に伸びる商人の路地と屋台',
      descriptionKey: "dungeon.types.silk_market.description",
    ...
    },
    {
      ...
      name: '長城高台',
      nameKey: "dungeon.types.great_wall_terrace.name",
      description: '城壁と展望台が交差する防衛構造',
      descriptionKey: "dungeon.types.great_wall_terrace.description",
    ...
    },
    {
      id: 'dragon-spine',
      name: '龍脈回廊',
      nameKey: "dungeon.types.dragon_spine.name",
      description: '龍の背骨のような弧状の回廊',
      descriptionKey: "dungeon.types.dragon_spine.description",
    ...
    },
    {
      id: 'scholar-archive',
      name: '翰林書庫',
      nameKey: "dungeon.types.scholar_archive.name",
      description: '書架と閲覧室が層を成す学術空間',
      descriptionKey: "dungeon.types.scholar_archive.description",
    ...
    },
    {
      ...
      name: '月影水路',
      nameKey: "dungeon.types.moonlit_waterways.name",
      description: '氷の水路と舟着き場が連なる夜景',
      descriptionKey: "dungeon.types.moonlit_waterways.description",
    ...
    },
    {
      id: 'jade-terraces',
      name: '翠玉連台',
      nameKey: "dungeon.types.jade_terraces.name",
      description: '段々畑のように広がる翠玉の庭園',
      descriptionKey: "dungeon.types.jade_terraces.description",
    ...
    },
    {
      id: 'lantern-festival',
      name: '燈海嘉年',
      nameKey: "dungeon.types.lantern_festival.name",
      description: '連なる提灯と露店が彩る祝祭の街路',
      descriptionKey: "dungeon.types.lantern_festival.description",
    ...
    },
    {
      id: 'opera-house',
      name: '梨園大戯',
      nameKey: "dungeon.types.opera_house.name",
      description: '舞台と客席が重層する大劇場',
      descriptionKey: "dungeon.types.opera_house.description",
    ...
    },
    {
      id: 'crane-sanctuary',
      name: '仙鶴雲苑',
      nameKey: "dungeon.types.crane_sanctuary.name",
      description: '雲水庭園に橋が螺旋する聖域',
      descriptionKey: "dungeon.types.crane_sanctuary.description",
    ...
    },
    {
      id: 'tea-pavilion',
      name: '香茗雲亭',
      nameKey: "dungeon.types.tea_pavilion.name",
      description: '茶亭と座敷が連なる静謐な庭園',
      descriptionKey: "dungeon.types.tea_pavilion.description",
  ...
  const blocks = {
    blocks1: [
      {
        key: 'jinluo_01',
        name: '金鑼街区',
        nameKey: "dungeon.types.silk_market.blocks.jinluo_01.name",
        level: 4,
        size: 0,
        depth: 2,
        chest: 'normal',
        type: 'silk-market',
        bossFloors: bossFloorsFor(12)
      },
      {
        key: 'jinluo_02',
        name: '金鑼夜市',
        nameKey: "dungeon.types.silk_market.blocks.jinluo_02.name",
        level: 7,
        size: 1,
        depth: 3,
        chest: 'more',
        type: 'silk-market',
        bossFloors: bossFloorsFor(14)
      },
      {
        key: 'jinluo_03',
        name: '金鑼豪市',
        nameKey: "dungeon.types.silk_market.blocks.jinluo_03.name",
        level: 10,
        size: 1,
        depth: 3,
        chest: 'normal',
        type: 'silk-market',
        bossFloors: bossFloorsFor(16)
      },
      {
        key: 'zijin_01',
        name: '紫禁正門',
        nameKey: "dungeon.types.imperial_courtyard.blocks.zijin_01.name",
        level: 8,
        size: 1,
        depth: 3,
        chest: 'less',
        type: 'imperial-courtyard',
        bossFloors: bossFloorsFor(12)
      },
      {
        key: 'zijin_02',
        name: '紫禁内苑',
        nameKey: "dungeon.types.imperial_courtyard.blocks.zijin_02.name",
        level: 12,
        size: 1,
        depth: 4,
        chest: 'normal',
        type: 'imperial-courtyard',
        bossFloors: bossFloorsFor(18)
      },
      {
        key: 'zijin_03',
        name: '紫禁儀殿',
        nameKey: "dungeon.types.imperial_courtyard.blocks.zijin_03.name",
        level: 16,
        size: 2,
        depth: 4,
        chest: 'more',
        type: 'imperial-courtyard',
        bossFloors: bossFloorsFor(20)
      },
      {
        key: 'jinglu_01',
        name: '京路胡同',
        nameKey: "dungeon.types.dragon_spine.blocks.jinglu_01.name",
        level: 5,
        size: 0,
        depth: 2,
        chest: 'less',
        type: 'dragon-spine',
        bossFloors: bossFloorsFor(10)
      },
      {
        key: 'jinglu_02',
        name: '京路龍鱗',
        nameKey: "dungeon.types.dragon_spine.blocks.jinglu_02.name",
        level: 11,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'jinglu_03',
        name: '京路龍脈',
        nameKey: "dungeon.types.dragon_spine.blocks.jinglu_03.name",
        level: 18,
        size: 2,
        depth: 4,
        chest: 'more',
        type: 'dragon-spine',
        bossFloors: bossFloorsFor(22)
      },
      {
        key: 'changcheng_01',
        name: '長城外哨',
        nameKey: "dungeon.types.great_wall_terrace.blocks.changcheng_01.name",
        level: 6,
        size: 0,
        depth: 2,
        chest: 'less',
        type: 'great-wall-terrace',
        bossFloors: bossFloorsFor(10)
      },
      {
        key: 'changcheng_02',
        name: '長城箭楼',
        nameKey: "dungeon.types.great_wall_terrace.blocks.changcheng_02.name",
        level: 13,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'changcheng_03',
        name: '長城烽台',
        nameKey: "dungeon.types.great_wall_terrace.blocks.changcheng_03.name",
        level: 20,
        size: 2,
        depth: 4,
        chest: 'more',
        type: 'great-wall-terrace',
        bossFloors: bossFloorsFor(24)
      },
      {
        key: 'hanlin_01',
        name: '翰林序館',
        nameKey: "dungeon.types.scholar_archive.blocks.hanlin_01.name",
        level: 9,
        size: 0,
        depth: 3,
        chest: 'normal',
        type: 'scholar-archive',
        bossFloors: bossFloorsFor(14)
      },
      {
        key: 'hanlin_02',
        name: '翰林内庫',
        nameKey: "dungeon.types.scholar_archive.blocks.hanlin_02.name",
        level: 15,
        size: 1,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'hanlin_03',
        name: '翰林秘閣',
        nameKey: "dungeon.types.scholar_archive.blocks.hanlin_03.name",
        level: 21,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'lianhua_01',
        name: '蓮華初層',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.lianhua_01.name",
        level: 3,
        size: -1,
        depth: 2,
        chest: 'normal',
        type: 'lotus-labyrinth',
        bossFloors: bossFloorsFor(8)
      },
      {
        key: 'lianhua_02',
        name: '蓮華霧層',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.lianhua_02.name",
        level: 9,
        size: 0,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'lianhua_03',
        name: '蓮華夜層',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.lianhua_03.name",
        level: 17,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'yueliang_01',
        name: '月梁水街',
        nameKey: "dungeon.types.moonlit_waterways.blocks.yueliang_01.name",
        level: 7,
        size: 0,
        depth: 3,
        chest: 'less',
        type: 'moonlit-waterways',
        bossFloors: bossFloorsFor(12)
      },
      {
        key: 'yueliang_02',
        name: '月梁寒渠',
        nameKey: "dungeon.types.moonlit_waterways.blocks.yueliang_02.name",
        level: 14,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'yueliang_03',
        name: '月梁霜港',
        nameKey: "dungeon.types.moonlit_waterways.blocks.yueliang_03.name",
        level: 22,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'tianwen_01',
        name: '天文前庭',
        nameKey: "dungeon.types.celestial_observatory.blocks.tianwen_01.name",
        level: 9,
        size: 0,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'tianwen_02',
        name: '天文星塔',
        nameKey: "dungeon.types.celestial_observatory.blocks.tianwen_02.name",
        level: 16,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'tianwen_03',
        name: '天文極殿',
        nameKey: "dungeon.types.celestial_observatory.blocks.tianwen_03.name",
        level: 23,
        size: 2,
        depth: 5,
        chest: 'normal',
        type: 'celestial-observatory',
        bossFloors: bossFloorsFor(26)
      },
      {
        key: 'cuitai_01',
        name: '翠台浅園',
        nameKey: "dungeon.types.jade_terraces.blocks.cuitai_01.name",
        level: 6,
        size: 0,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'cuitai_02',
        name: '翠台深苑',
        nameKey: "dungeon.types.jade_terraces.blocks.cuitai_02.name",
        level: 13,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'cuitai_03',
        name: '翠台玉峰',
        nameKey: "dungeon.types.jade_terraces.blocks.cuitai_03.name",
        level: 21,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'denghai_01',
        name: '燈海市街',
        nameKey: "dungeon.types.lantern_festival.blocks.denghai_01.name",
        level: 7,
        size: 0,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'denghai_02',
        name: '燈海慶宴',
        nameKey: "dungeon.types.lantern_festival.blocks.denghai_02.name",
        level: 14,
        size: 1,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'denghai_03',
        name: '燈海宵宮',
        nameKey: "dungeon.types.lantern_festival.blocks.denghai_03.name",
        level: 22,
        size: 2,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'liyuan_01',
        name: '梨園雅台',
        nameKey: "dungeon.types.opera_house.blocks.liyuan_01.name",
        level: 10,
        size: 1,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'liyuan_02',
        name: '梨園霓殿',
        nameKey: "dungeon.types.opera_house.blocks.liyuan_02.name",
        level: 17,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'liyuan_03',
        name: '梨園極舞',
        nameKey: "dungeon.types.opera_house.blocks.liyuan_03.name",
        level: 24,
        size: 2,
        depth: 5,
        chest: 'more',
        type: 'opera-house',
        bossFloors: bossFloorsFor(28)
      },
      {
        key: 'xianhe_01',
        name: '仙鶴水苑',
        nameKey: "dungeon.types.crane_sanctuary.blocks.xianhe_01.name",
        level: 8,
        size: 0,
        depth: 3,
        chest: 'less',
        type: 'crane-sanctuary',
        bossFloors: bossFloorsFor(14)
      },
      {
        key: 'xianhe_02',
        name: '仙鶴雲台',
        nameKey: "dungeon.types.crane_sanctuary.blocks.xianhe_02.name",
        level: 15,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'xianhe_03',
        name: '仙鶴星舞',
        nameKey: "dungeon.types.crane_sanctuary.blocks.xianhe_03.name",
        level: 23,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'xiangming_01',
        name: '香茗茶肆',
        nameKey: "dungeon.types.tea_pavilion.blocks.xiangming_01.name",
        level: 6,
        size: 0,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        key: 'xiangming_02',
        name: '香茗御亭',
        nameKey: "dungeon.types.tea_pavilion.blocks.xiangming_02.name",
        level: 12,
        size: 1,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'xiangming_03',
        name: '香茗霧榭',
        nameKey: "dungeon.types.tea_pavilion.blocks.xiangming_03.name",
        level: 19,
        size: 1,
        depth: 4,
        chest: 'more',
    ...
    blocks2: [
      {
        key: 'mingshi_01',
        name: '名市小径',
        nameKey: "dungeon.types.silk_market.blocks.mingshi_01.name",
        level: 6,
        size: 0,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        key: 'mingshi_02',
        name: '名市帳幕',
        nameKey: "dungeon.types.silk_market.blocks.mingshi_02.name",
        level: 12,
        size: 1,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'mingshi_03',
        name: '名市楼閣',
        nameKey: "dungeon.types.silk_market.blocks.mingshi_03.name",
        level: 18,
        size: 2,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'huadian_01',
        name: '花殿回廊',
        nameKey: "dungeon.types.imperial_courtyard.blocks.huadian_01.name",
        level: 10,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'huadian_02',
        name: '花殿主殿',
        nameKey: "dungeon.types.imperial_courtyard.blocks.huadian_02.name",
        level: 16,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'huadian_03',
        name: '花殿玉階',
        nameKey: "dungeon.types.imperial_courtyard.blocks.huadian_03.name",
        level: 22,
        size: 2,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'longyin_01',
        name: '龍吟巷',
        nameKey: "dungeon.types.dragon_spine.blocks.longyin_01.name",
        level: 8,
        size: 0,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'longyin_02',
        name: '龍吟華軒',
        nameKey: "dungeon.types.dragon_spine.blocks.longyin_02.name",
        level: 15,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'longyin_03',
        name: '龍吟梧宮',
        nameKey: "dungeon.types.dragon_spine.blocks.longyin_03.name",
        level: 23,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'yanmen_01',
        name: '雁門関廊',
        nameKey: "dungeon.types.great_wall_terrace.blocks.yanmen_01.name",
        level: 9,
        size: 0,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        key: 'yanmen_02',
        name: '雁門砦楼',
        nameKey: "dungeon.types.great_wall_terrace.blocks.yanmen_02.name",
        level: 17,
        size: 1,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'yanmen_03',
        name: '雁門烽楼',
        nameKey: "dungeon.types.great_wall_terrace.blocks.yanmen_03.name",
        level: 24,
        size: 2,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'wenxin_01',
        name: '文心閲廊',
        nameKey: "dungeon.types.scholar_archive.blocks.wenxin_01.name",
        level: 11,
        size: 0,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'wenxin_02',
        name: '文心秘庫',
        nameKey: "dungeon.types.scholar_archive.blocks.wenxin_02.name",
        level: 18,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'wenxin_03',
        name: '文心玉架',
        nameKey: "dungeon.types.scholar_archive.blocks.wenxin_03.name",
        level: 25,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'shuilian_01',
        name: '水蓮回庭',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.shuilian_01.name",
        level: 5,
        size: 0,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        key: 'shuilian_02',
        name: '水蓮幻郭',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.shuilian_02.name",
        level: 13,
        size: 1,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'shuilian_03',
        name: '水蓮星殿',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.shuilian_03.name",
        level: 20,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'liangyue_01',
        name: '涼月津',
        nameKey: "dungeon.types.moonlit_waterways.blocks.liangyue_01.name",
        level: 9,
        size: 0,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'liangyue_02',
        name: '涼月霜渠',
        nameKey: "dungeon.types.moonlit_waterways.blocks.liangyue_02.name",
        level: 16,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'liangyue_03',
        name: '涼月天港',
        nameKey: "dungeon.types.moonlit_waterways.blocks.liangyue_03.name",
        level: 24,
        size: 2,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'xingguan_01',
        name: '星観迴廊',
        nameKey: "dungeon.types.celestial_observatory.blocks.xingguan_01.name",
        level: 11,
        size: 0,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'xingguan_02',
        name: '星観塔層',
        nameKey: "dungeon.types.celestial_observatory.blocks.xingguan_02.name",
        level: 18,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'xingguan_03',
        name: '星観穹宮',
        nameKey: "dungeon.types.celestial_observatory.blocks.xingguan_03.name",
        level: 25,
        size: 2,
        depth: 5,
        chest: 'less',
      ...
      },
      {
        key: 'yuta_01',
        name: '玉台浅苑',
        nameKey: "dungeon.types.jade_terraces.blocks.yuta_01.name",
        level: 9,
        size: 0,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'yuta_02',
        name: '玉台翠庭',
        nameKey: "dungeon.types.jade_terraces.blocks.yuta_02.name",
        level: 15,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'yuta_03',
        name: '玉台霊峰',
        nameKey: "dungeon.types.jade_terraces.blocks.yuta_03.name",
        level: 22,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'zhaohui_01',
        name: '照輝街巷',
        nameKey: "dungeon.types.lantern_festival.blocks.zhaohui_01.name",
        level: 10,
        size: 0,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'zhaohui_02',
        name: '照輝夜市',
        nameKey: "dungeon.types.lantern_festival.blocks.zhaohui_02.name",
        level: 17,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'zhaohui_03',
        name: '照輝長廊',
        nameKey: "dungeon.types.lantern_festival.blocks.zhaohui_03.name",
        level: 23,
        size: 2,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'liyuan_04',
        name: '梨園雅席',
        nameKey: "dungeon.types.opera_house.blocks.liyuan_04.name",
        level: 12,
        size: 1,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'liyuan_05',
        name: '梨園錦幕',
        nameKey: "dungeon.types.opera_house.blocks.liyuan_05.name",
        level: 19,
        size: 1,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'xianhe_04',
        name: '仙鶴霧橋',
        nameKey: "dungeon.types.crane_sanctuary.blocks.xianhe_04.name",
        level: 13,
        size: 0,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'xianhe_05',
        name: '仙鶴雲路',
        nameKey: "dungeon.types.crane_sanctuary.blocks.xianhe_05.name",
        level: 20,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'xiangming_04',
        name: '香茗茶舟',
        nameKey: "dungeon.types.tea_pavilion.blocks.xiangming_04.name",
        level: 11,
        size: 0,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'xiangming_05',
        name: '香茗花亭',
        nameKey: "dungeon.types.tea_pavilion.blocks.xiangming_05.name",
        level: 18,
        size: 1,
        depth: 3,
        chest: 'normal',
    ...
    blocks3: [
      {
        key: 'huangyu_01',
        name: '皇御斎殿',
        nameKey: "dungeon.types.imperial_courtyard.blocks.huangyu_01.name",
        level: 14,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'huangyu_02',
        name: '皇御宸極',
        nameKey: "dungeon.types.imperial_courtyard.blocks.huangyu_02.name",
        level: 20,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'huangyu_03',
        name: '皇御星穹',
        nameKey: "dungeon.types.imperial_courtyard.blocks.huangyu_03.name",
        level: 27,
        size: 2,
        depth: 5,
        chest: 'less',
      ...
      },
      {
        key: 'longxin_01',
        name: '龍心宝庫',
        nameKey: "dungeon.types.dragon_spine.blocks.longxin_01.name",
        level: 15,
        size: 1,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'longxin_02',
        name: '龍心霊壇',
        nameKey: "dungeon.types.dragon_spine.blocks.longxin_02.name",
        level: 22,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'longxin_03',
        name: '龍心雲闕',
        nameKey: "dungeon.types.dragon_spine.blocks.longxin_03.name",
        level: 29,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'changsheng_01',
        name: '長勝烽堡',
        nameKey: "dungeon.types.great_wall_terrace.blocks.changsheng_01.name",
        level: 16,
        size: 1,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'changsheng_02',
        name: '長勝天闕',
        nameKey: "dungeon.types.great_wall_terrace.blocks.changsheng_02.name",
        level: 23,
        size: 2,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'changsheng_03',
        name: '長勝雲堞',
        nameKey: "dungeon.types.great_wall_terrace.blocks.changsheng_03.name",
        level: 30,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'lianxin_01',
        name: '蓮心霧宮',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.lianxin_01.name",
        level: 12,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'lianxin_02',
        name: '蓮心星塔',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.lianxin_02.name",
        level: 19,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'lianxin_03',
        name: '蓮心天蓬',
        nameKey: "dungeon.types.lotus_labyrinth.blocks.lianxin_03.name",
        level: 26,
        size: 2,
        depth: 5,
        chest: 'less',
      ...
      },
      {
        key: 'shangshi_01',
        name: '商市耀庭',
        nameKey: "dungeon.types.silk_market.blocks.shangshi_01.name",
        level: 13,
        size: 1,
        depth: 3,
        chest: 'more',
      ...
      },
      {
        key: 'shangshi_02',
        name: '商市霓楼',
        nameKey: "dungeon.types.silk_market.blocks.shangshi_02.name",
        level: 21,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'shangshi_03',
        name: '商市金穹',
        nameKey: "dungeon.types.silk_market.blocks.shangshi_03.name",
        level: 28,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'hanxin_01',
        name: '翰心星閲',
        nameKey: "dungeon.types.scholar_archive.blocks.hanxin_01.name",
        level: 17,
        size: 1,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        key: 'hanxin_02',
        name: '翰心霜庫',
        nameKey: "dungeon.types.scholar_archive.blocks.hanxin_02.name",
        level: 24,
        size: 2,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'hanxin_03',
        name: '翰心辰宮',
        nameKey: "dungeon.types.scholar_archive.blocks.hanxin_03.name",
        level: 31,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'yuexiang_01',
        name: '月香流光',
        nameKey: "dungeon.types.moonlit_waterways.blocks.yuexiang_01.name",
        level: 14,
        size: 1,
        depth: 3,
        chest: 'normal',
      ...
      },
      {
        key: 'yuexiang_02',
        name: '月香寒波',
        nameKey: "dungeon.types.moonlit_waterways.blocks.yuexiang_02.name",
        level: 22,
        size: 1,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'yuexiang_03',
        name: '月香雪港',
        nameKey: "dungeon.types.moonlit_waterways.blocks.yuexiang_03.name",
        level: 30,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'starcrest_01',
        name: '星冠観測',
        nameKey: "dungeon.types.celestial_observatory.blocks.starcrest_01.name",
        level: 18,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'starcrest_02',
        name: '星冠律塔',
        nameKey: "dungeon.types.celestial_observatory.blocks.starcrest_02.name",
        level: 26,
        size: 2,
        depth: 5,
        chest: 'normal',
      ...
      },
      {
        key: 'starcrest_03',
        name: '星冠穹儀',
        nameKey: "dungeon.types.celestial_observatory.blocks.starcrest_03.name",
        level: 33,
        size: 3,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'emerald_01',
        name: '翡翠段陵',
        nameKey: "dungeon.types.jade_terraces.blocks.emerald_01.name",
        level: 17,
        size: 1,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'emerald_02',
        name: '翡翠雲壇',
        nameKey: "dungeon.types.jade_terraces.blocks.emerald_02.name",
        level: 25,
        size: 2,
        depth: 5,
        chest: 'normal',
      ...
      },
      {
        key: 'emerald_03',
        name: '翡翠霊峰',
        nameKey: "dungeon.types.jade_terraces.blocks.emerald_03.name",
        level: 32,
        size: 3,
        depth: 6,
        chest: 'more',
      ...
      },
      {
        key: 'festival_01',
        name: '灯宴極街',
        nameKey: "dungeon.types.lantern_festival.blocks.festival_01.name",
        level: 19,
        size: 1,
        depth: 4,
        chest: 'more',
      ...
      },
      {
        key: 'festival_02',
        name: '灯宴宵城',
        nameKey: "dungeon.types.lantern_festival.blocks.festival_02.name",
        level: 27,
        size: 2,
        depth: 5,
        chest: 'normal',
      ...
      },
      {
        key: 'festival_03',
        name: '灯宴星都',
        nameKey: "dungeon.types.lantern_festival.blocks.festival_03.name",
        level: 34,
        size: 3,
        depth: 6,
        chest: 'more',
      ...
      },
      {
        key: 'grandopera_01',
        name: '戯都雅廊',
        nameKey: "dungeon.types.opera_house.blocks.grandopera_01.name",
        level: 20,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'grandopera_02',
        name: '戯都彩殿',
        nameKey: "dungeon.types.opera_house.blocks.grandopera_02.name",
        level: 28,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'grandopera_03',
        name: '戯都霓穹',
        nameKey: "dungeon.types.opera_house.blocks.grandopera_03.name",
        level: 35,
        size: 3,
        depth: 6,
        chest: 'more',
      ...
      },
      {
        key: 'cranecloud_01',
        name: '鶴雲環洲',
        nameKey: "dungeon.types.crane_sanctuary.blocks.cranecloud_01.name",
        level: 18,
        size: 1,
        depth: 4,
        chest: 'less',
      ...
      },
      {
        key: 'cranecloud_02',
        name: '鶴雲聖蓮',
        nameKey: "dungeon.types.crane_sanctuary.blocks.cranecloud_02.name",
        level: 26,
        size: 2,
        depth: 5,
        chest: 'normal',
      ...
      },
      {
        key: 'cranecloud_03',
        name: '鶴雲霊橋',
        nameKey: "dungeon.types.crane_sanctuary.blocks.cranecloud_03.name",
        level: 33,
        size: 3,
        depth: 6,
        chest: 'more',
      ...
      },
      {
        key: 'pavilion_01',
        name: '茗亭雲居',
        nameKey: "dungeon.types.tea_pavilion.blocks.pavilion_01.name",
        level: 17,
        size: 1,
        depth: 4,
        chest: 'normal',
      ...
      },
      {
        key: 'pavilion_02',
        name: '茗亭霧軒',
        nameKey: "dungeon.types.tea_pavilion.blocks.pavilion_02.name",
        level: 24,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'pavilion_03',
        name: '茗亭香閣',
        nameKey: "dungeon.types.tea_pavilion.blocks.pavilion_03.name",
        level: 31,
        size: 3,
        depth: 6,
        chest: 'more',
    ...
    blocks4: [
      {
        key: 'constellation_01',
        name: '星羅雲殿',
        nameKey: "dungeon.types.celestial_observatory.blocks.constellation_01.name",
        level: 24,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      {
        key: 'constellation_02',
        name: '星羅宙宮',
        nameKey: "dungeon.types.celestial_observatory.blocks.constellation_02.name",
        level: 31,
        size: 3,
        depth: 6,
        chest: 'normal',
      ...
      {
        key: 'constellation_03',
        name: '星羅永極',
        nameKey: "dungeon.types.celestial_observatory.blocks.constellation_03.name",
        level: 38,
        size: 3,
        depth: 7,
        chest: 'more',
      ...
      },
      {
        key: 'emeraldcrest_01',
        name: '翠冠梯苑',
        nameKey: "dungeon.types.jade_terraces.blocks.emeraldcrest_01.name",
        level: 23,
        size: 2,
        depth: 5,
        chest: 'normal',
      ...
      },
      {
        key: 'emeraldcrest_02',
        name: '翠冠霊台',
        nameKey: "dungeon.types.jade_terraces.blocks.emeraldcrest_02.name",
        level: 30,
        size: 3,
        depth: 6,
        chest: 'more',
      ...
      },
      {
        key: 'emeraldcrest_03',
        name: '翠冠仙壇',
        nameKey: "dungeon.types.jade_terraces.blocks.emeraldcrest_03.name",
        level: 37,
        size: 3,
        depth: 7,
        chest: 'less',
      ...
      },
      {
        key: 'radiantgala_01',
        name: '燈耀宵宴',
        nameKey: "dungeon.types.lantern_festival.blocks.radiantgala_01.name",
        level: 25,
        size: 2,
        depth: 5,
        chest: 'more',
      ...
      },
      {
        key: 'radiantgala_02',
        name: '燈耀星街',
        nameKey: "dungeon.types.lantern_festival.blocks.radiantgala_02.name",
        level: 32,
        size: 3,
        depth: 6,
        chest: 'normal',
      ...
      },
      {
        key: 'radiantgala_03',
        name: '燈耀霓京',
        nameKey: "dungeon.types.lantern_festival.blocks.radiantgala_03.name",
        level: 39,
        size: 3,
        depth: 7,
        chest: 'more',
      ...
      },
      {
        key: 'royalopera_01',
        name: '戯皇瑠殿',
        nameKey: "dungeon.types.opera_house.blocks.royalopera_01.name",
        level: 26,
        size: 2,
        depth: 5,
        chest: 'less',
      ...
      },
      {
        key: 'royalopera_02',
        name: '戯皇星舞',
        nameKey: "dungeon.types.opera_house.blocks.royalopera_02.name",
        level: 33,
        size: 3,
        depth: 6,
        chest: 'normal',
      ...
      },
      {
        key: 'royalopera_03',
        name: '戯皇虹蓋',
        nameKey: "dungeon.types.opera_house.blocks.royalopera_03.name",
        level: 40,
        size: 3,
        depth: 7,
        chest: 'more',
      ...
      },
      {
        key: 'cranesummit_01',
        name: '鶴頂浮洲',
        nameKey: "dungeon.types.crane_sanctuary.blocks.cranesummit_01.name",
        level: 24,
        size: 2,
        depth: 5,
        chest: 'normal',
      ...
      },
      {
        key: 'cranesummit_02',
        name: '鶴頂翔庭',
        nameKey: "dungeon.types.crane_sanctuary.blocks.cranesummit_02.name",
        level: 31,
        size: 3,
        depth: 6,
        chest: 'less',
      ...
      },
      {
        key: 'cranesummit_03',
        name: '鶴頂雲極',
        nameKey: "dungeon.types.crane_sanctuary.blocks.cranesummit_03.name",
        level: 38,
        size: 3,
        depth: 7,
        chest: 'more',
      ...
      },
      {
        key: 'jadebrew_01',
        name: '茗冠香庭',
        nameKey: "dungeon.types.tea_pavilion.blocks.jadebrew_01.name",
        level: 23,
        size: 2,
        depth: 5,
        chest: 'less',
      ...
      },
      {
        key: 'jadebrew_02',
        name: '茗冠霧亭',
        nameKey: "dungeon.types.tea_pavilion.blocks.jadebrew_02.name",
        level: 30,
        size: 3,
        depth: 6,
        chest: 'normal',
      ...
      },
      {
        key: 'jadebrew_03',
        name: '茗冠星閣',
        nameKey: "dungeon.types.tea_pavilion.blocks.jadebrew_03.name",
        level: 37,
        size: 3,
        depth: 7,
        chest: 'more',
