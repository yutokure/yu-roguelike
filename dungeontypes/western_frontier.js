(function(){
  ...
  const blocks = {
    blocks1: [
      {
        key: 'western_story_01',
        name: 'Western Story I',
        nameKey: "dungeon.types.frontier_main_street.blocks.western_story_01.name",
        level: -6,
        size: -1,
        depth: 0,
        chest: 'less',
        type: 'frontier-main-street',
        bossFloors: mkBossFloors([5])
      },
      {
        key: 'western_story_02',
        name: 'Western Story II',
        nameKey: "dungeon.types.frontier_main_street.blocks.western_story_02.name",
        level: -3,
        size: 0,
        depth: 0,
        chest: 'normal',
        type: 'frontier-main-street',
        bossFloors: mkBossFloors([5,10])
      },
      {
        key: 'western_story_03',
        name: 'Western Story III',
        nameKey: "dungeon.types.frontier_main_street.blocks.western_story_03.name",
        level: 0,
        size: 1,
        depth: 1,
        chest: 'more',
        type: 'frontier-main-street',
        bossFloors: mkBossFloors([10])
      },
      {
        key: 'western_story_04',
        name: 'Western Story IV',
        nameKey: "dungeon.types.frontier_main_street.blocks.western_story_04.name",
        level: 3,
        size: 1,
        depth: 1,
        chest: 'normal',
      ...
      {
        key: 'western_story_05',
        name: 'Western Story V',
        nameKey: "dungeon.types.frontier_main_street.blocks.western_story_05.name",
        level: 6,
        size: 1,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'mesa_border_01',
        name: 'Mesa Border I',
        nameKey: "dungeon.types.canyon_meanders.blocks.mesa_border_01.name",
        level: -4,
        size: 0,
        depth: 1,
        chest: 'normal',
        type: 'canyon-meanders',
        bossFloors: mkBossFloors([6])
      },
      {
        key: 'mesa_border_02',
        name: 'Mesa Border II',
        nameKey: "dungeon.types.canyon_meanders.blocks.mesa_border_02.name",
        level: 2,
        size: 0,
        depth: 1,
        chest: 'normal',
      ...
      },
      {
        ...
        nameKey: "dungeon.types.canyon_meanders.blocks.mesa_border_03.name",
        level: 8,
        size: 1,
        depth: 2,
        chest: 'more',
      ...
      },
      {
        key: 'mesa_border_04',
        name: 'Mesa Border IV',
        nameKey: "dungeon.types.canyon_meanders.blocks.mesa_border_04.name",
        level: 14,
        size: 1,
        depth: 2,
        chest: 'less',
        type: 'canyon-meanders',
        bossFloors: mkBossFloors([24])
      },
      {
        key: 'ghost_hollow_01',
        name: 'Ghost Hollow I',
        nameKey: "dungeon.types.ghost_town_hollows.blocks.ghost_hollow_01.name",
        level: -2,
        size: 0,
        depth: 1,
        chest: 'normal',
        type: 'ghost-town-hollows',
        bossFloors: mkBossFloors([7])
      },
      {
        key: 'ghost_hollow_02',
        name: 'Ghost Hollow II',
        nameKey: "dungeon.types.ghost_town_hollows.blocks.ghost_hollow_02.name",
        level: 4,
        size: 1,
        depth: 1,
        chest: 'less',
      ...
      },
      {
        ...
        nameKey: "dungeon.types.ghost_town_hollows.blocks.ghost_hollow_03.name",
        level: 10,
        size: 1,
        depth: 2,
        chest: 'more',
      ...
      {
        key: 'badlands_trail_01',
        name: 'Badlands Trail I',
        nameKey: "dungeon.types.sunset_badlands.blocks.badlands_trail_01.name",
        level: -3,
        size: 0,
        depth: 0,
        chest: 'normal',
        type: 'sunset-badlands',
        bossFloors: mkBossFloors([6])
      },
      {
        key: 'badlands_trail_02',
        name: 'Badlands Trail II',
        nameKey: "dungeon.types.sunset_badlands.blocks.badlands_trail_02.name",
        level: 3,
        size: 1,
        depth: 1,
        chest: 'less',
      ...
      {
        key: 'badlands_trail_03',
        name: 'Badlands Trail III',
        nameKey: "dungeon.types.sunset_badlands.blocks.badlands_trail_03.name",
        level: 9,
        size: 1,
        depth: 1,
        chest: 'normal',
      ...
      {
        key: 'sagebrush_circle_01',
        name: 'Sagebrush Circle I',
        nameKey: "dungeon.types.sagebrush_basin.blocks.sagebrush_circle_01.name",
        level: 1,
        size: 0,
        depth: 1,
        chest: 'normal',
        type: 'sagebrush-basin',
        bossFloors: mkBossFloors([8])
      },
      {
        key: 'sagebrush_circle_02',
        name: 'Sagebrush Circle II',
        nameKey: "dungeon.types.sagebrush_basin.blocks.sagebrush_circle_02.name",
        level: 7,
        size: 1,
        depth: 1,
        chest: 'more',
      ...
      },
      {
        key: 'thunderfront_01',
        name: 'Thunderfront I',
        nameKey: "dungeon.types.thunder_mesa.blocks.thunderfront_01.name",
        level: 5,
        size: 1,
        depth: 1,
        chest: 'normal',
      ...
      {
        key: 'citadel_patrol_01',
        name: 'Citadel Patrol I',
        nameKey: "dungeon.types.frontier_citadel.blocks.citadel_patrol_01.name",
        level: 2,
        size: 0,
        depth: 1,
        chest: 'normal',
        type: 'frontier-citadel',
        bossFloors: mkBossFloors([9])
      },
      {
        key: 'hoodoo_column_01',
        name: 'Hoodoo Columns I',
        nameKey: "dungeon.types.hoodoo_needles.blocks.hoodoo_column_01.name",
        level: -1,
        size: 0,
        depth: 1,
        chest: 'less',
      ...
      },
      {
        key: 'wagon_depot_01',
        name: 'Wagon Depot I',
        nameKey: "dungeon.types.wagon_yard_sprawl.blocks.wagon_depot_01.name",
        level: 4,
        size: 1,
        depth: 1,
        chest: 'normal',
        type: 'wagon-yard-sprawl',
        bossFloors: mkBossFloors([12])
      },
      {
        key: 'silver_crossing_01',
        name: 'Silver Crossing I',
        nameKey: "dungeon.types.silver_creek_crossing.blocks.silver_crossing_01.name",
        level: 1,
        size: 0,
        depth: 1,
        chest: 'more',
        type: 'silver-creek-crossing',
        bossFloors: mkBossFloors([11])
      },
      {
        key: 'painted_switchbacks_01',
        name: 'Painted Switchbacks I',
        nameKey: "dungeon.types.painted_switchbacks.blocks.painted_switchbacks_01.name",
        level: 6,
        size: 1,
        depth: 1,
        chest: 'less',
        type: 'painted-switchbacks',
        bossFloors: mkBossFloors([13])
      },
      {
        key: 'coyote_den_01',
        name: 'Coyote Den I',
        nameKey: "dungeon.types.coyote_den_network.blocks.coyote_den_01.name",
        level: -2,
        size: 0,
        depth: 1,
        chest: 'normal',
        type: 'coyote-den-network',
        bossFloors: mkBossFloors([6])
      },
    ],
    blocks2: [
      {
        key: 'railspur_01',
        name: 'Railspur I',
        nameKey: "dungeon.types.railway_warrens.blocks.railspur_01.name",
        level: 0,
        size: 1,
        depth: 0,
        chest: 'normal',
        type: 'railway-warrens'
      },
      {
        key: 'railspur_02',
        name: 'Railspur II',
        nameKey: "dungeon.types.railway_warrens.blocks.railspur_02.name",
        level: 5,
        size: 1,
        depth: 1,
        chest: 'more',
      ...
      },
      {
        key: 'railspur_03',
        name: 'Railspur III',
        nameKey: "dungeon.types.railway_warrens.blocks.railspur_03.name",
        level: 10,
        size: 2,
        depth: 1,
        chest: 'less',
      ...
      },
      {
        key: 'railspur_04',
        name: 'Railspur IV',
        nameKey: "dungeon.types.railway_warrens.blocks.railspur_04.name",
        level: 15,
        size: 2,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        key: 'railspur_05',
        name: 'Railspur V',
        nameKey: "dungeon.types.railway_warrens.blocks.railspur_05.name",
        level: 20,
        size: 3,
        depth: 2,
        chest: 'more',
      ...
      {
        key: 'stampede_pass_01',
        name: 'Stampede Pass I',
        nameKey: "dungeon.types.stampede_ridge.blocks.stampede_pass_01.name",
        level: -1,
        size: 0,
        depth: 1,
        chest: 'normal',
      ...
      {
        key: 'stampede_pass_02',
        name: 'Stampede Pass II',
        nameKey: "dungeon.types.stampede_ridge.blocks.stampede_pass_02.name",
        level: 6,
        size: 1,
        depth: 1,
        chest: 'less',
      ...
      {
        key: 'stampede_pass_03',
        name: 'Stampede Pass III',
        nameKey: "dungeon.types.stampede_ridge.blocks.stampede_pass_03.name",
        level: 12,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      {
        key: 'stampede_pass_04',
        name: 'Stampede Pass IV',
        nameKey: "dungeon.types.stampede_ridge.blocks.stampede_pass_04.name",
        level: 18,
        size: 2,
        depth: 2,
        chest: 'more',
      ...
      },
      {
        key: 'saltway_01',
        name: 'Saltway I',
        nameKey: "dungeon.types.salt_flat_ruins.blocks.saltway_01.name",
        level: 2,
        size: 0,
        depth: 1,
        chest: 'normal',
        type: 'salt-flat-ruins'
      },
      {
        key: 'saltway_02',
        name: 'Saltway II',
        nameKey: "dungeon.types.salt_flat_ruins.blocks.saltway_02.name",
        level: 8,
        size: 1,
        depth: 1,
        chest: 'less',
      ...
      },
      {
        key: 'saltway_03',
        name: 'Saltway III',
        nameKey: "dungeon.types.salt_flat_ruins.blocks.saltway_03.name",
        level: 16,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        key: 'saltway_04',
        name: 'Saltway IV',
        nameKey: "dungeon.types.salt_flat_ruins.blocks.saltway_04.name",
        level: 24,
        size: 2,
        depth: 2,
        chest: 'more',
      ...
      {
        key: 'badlands_trail_04',
        name: 'Badlands Trail IV',
        nameKey: "dungeon.types.sunset_badlands.blocks.badlands_trail_04.name",
        level: 18,
        size: 2,
        depth: 2,
        chest: 'more',
      ...
      {
        key: 'sagebrush_circle_03',
        name: 'Sagebrush Circle III',
        nameKey: "dungeon.types.sagebrush_basin.blocks.sagebrush_circle_03.name",
        level: 14,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      },
      {
        ...
        nameKey: "dungeon.types.thunder_mesa.blocks.thunderfront_02.name",
        level: 20,
        size: 2,
        depth: 2,
        chest: 'less',
      ...
      {
        key: 'citadel_patrol_02',
        name: 'Citadel Patrol II',
        nameKey: "dungeon.types.frontier_citadel.blocks.citadel_patrol_02.name",
        level: 12,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      {
        key: 'hoodoo_column_02',
        name: 'Hoodoo Columns II',
        nameKey: "dungeon.types.hoodoo_needles.blocks.hoodoo_column_02.name",
        level: 8,
        size: 1,
        depth: 2,
        chest: 'less',
      ...
      },
      {
        key: 'wagon_depot_02',
        name: 'Wagon Depot II',
        nameKey: "dungeon.types.wagon_yard_sprawl.blocks.wagon_depot_02.name",
        level: 15,
        size: 2,
        depth: 2,
        chest: 'more',
      ...
      {
        key: 'silver_crossing_02',
        name: 'Silver Crossing II',
        nameKey: "dungeon.types.silver_creek_crossing.blocks.silver_crossing_02.name",
        level: 10,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      {
        key: 'painted_switchbacks_02',
        name: 'Painted Switchbacks II',
        nameKey: "dungeon.types.painted_switchbacks.blocks.painted_switchbacks_02.name",
        level: 18,
        size: 2,
        depth: 2,
        chest: 'more',
      ...
      },
      {
        key: 'coyote_den_02',
        name: 'Coyote Den II',
        nameKey: "dungeon.types.coyote_den_network.blocks.coyote_den_02.name",
        level: 6,
        size: 1,
        depth: 2,
        chest: 'less',
    ...
    blocks3: [
      {
        key: 'frontier_relic_01',
        name: 'Frontier Relic I',
        nameKey: "dungeon.types.ghost_town_hollows.blocks.frontier_relic_01.name",
        level: 4,
        size: 1,
        depth: 2,
        chest: 'more',
      ...
      {
        key: 'frontier_relic_02',
        name: 'Frontier Relic II',
        nameKey: "dungeon.types.canyon_meanders.blocks.frontier_relic_02.name",
        level: 11,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      {
        key: 'frontier_relic_03',
        name: 'Frontier Relic III',
        nameKey: "dungeon.types.railway_warrens.blocks.frontier_relic_03.name",
        level: 18,
        size: 2,
        depth: 3,
        chest: 'less',
      ...
      {
        key: 'frontier_relic_04',
        name: 'Frontier Relic IV',
        nameKey: "dungeon.types.frontier_main_street.blocks.frontier_relic_04.name",
        level: 25,
        size: 2,
        depth: 3,
        chest: 'normal',
        type: 'frontier-main-street',
        bossFloors: mkBossFloors([25])
      },
      {
        key: 'frontier_relic_05',
        name: 'Frontier Relic V',
        nameKey: "dungeon.types.salt_flat_ruins.blocks.frontier_relic_05.name",
        level: 30,
        size: 3,
        depth: 4,
        chest: 'more',
        type: 'salt-flat-ruins',
        bossFloors: mkBossFloors([30])
      },
      {
        key: 'sheriff_legacy_01',
        name: 'Sheriff Legacy I',
        nameKey: "dungeon.types.frontier_main_street.blocks.sheriff_legacy_01.name",
        level: 7,
        size: 1,
        depth: 2,
        chest: 'normal',
      ...
      {
        key: 'sheriff_legacy_02',
        name: 'Sheriff Legacy II',
        nameKey: "dungeon.types.ghost_town_hollows.blocks.sheriff_legacy_02.name",
        level: 13,
        size: 1,
        depth: 3,
        chest: 'less',
      ...
      {
        key: 'sheriff_legacy_03',
        name: 'Sheriff Legacy III',
        nameKey: "dungeon.types.stampede_ridge.blocks.sheriff_legacy_03.name",
        level: 22,
        size: 2,
        depth: 3,
        chest: 'normal',
        type: 'stampede-ridge',
        bossFloors: mkBossFloors([22,28])
      },
      {
        key: 'sheriff_legacy_04',
        name: 'Sheriff Legacy IV',
        nameKey: "dungeon.types.canyon_meanders.blocks.sheriff_legacy_04.name",
        level: 28,
        size: 2,
        depth: 4,
        chest: 'more',
        type: 'canyon-meanders',
        bossFloors: mkBossFloors([26,32])
      },
      {
        key: 'badlands_legend_01',
        name: 'Badlands Legend I',
        nameKey: "dungeon.types.sunset_badlands.blocks.badlands_legend_01.name",
        level: 26,
        size: 2,
        depth: 3,
        chest: 'normal',
        type: 'sunset-badlands',
        bossFloors: mkBossFloors([24,30])
      },
      {
        key: 'sagebrush_legacy_01',
        name: 'Sagebrush Legacy I',
        nameKey: "dungeon.types.sagebrush_basin.blocks.sagebrush_legacy_01.name",
        level: 32,
        size: 3,
        depth: 4,
        chest: 'more',
        type: 'sagebrush-basin',
        bossFloors: mkBossFloors([32])
      },
      {
        key: 'thunderfront_legend',
        name: 'Thunderfront Legend',
        nameKey: "dungeon.types.thunder_mesa.blocks.thunderfront_legend.name",
        level: 34,
        size: 3,
        depth: 4,
        chest: 'more',
        type: 'thunder-mesa',
        bossFloors: mkBossFloors([34])
      },
      {
        key: 'citadel_patrol_03',
        name: 'Citadel Patrol III',
        nameKey: "dungeon.types.frontier_citadel.blocks.citadel_patrol_03.name",
        level: 24,
        size: 2,
        depth: 3,
        chest: 'normal',
      ...
      {
        key: 'hoodoo_column_03',
        name: 'Hoodoo Columns III',
        nameKey: "dungeon.types.hoodoo_needles.blocks.hoodoo_column_03.name",
        level: 20,
        size: 2,
        depth: 3,
        chest: 'less',
      ...
      },
      {
        ...
        nameKey: "dungeon.types.wagon_yard_sprawl.blocks.wagon_depot_03.name",
        level: 27,
        size: 2,
        depth: 3,
        chest: 'more',
      ...
      {
        key: 'silver_crossing_03',
        name: 'Silver Crossing III',
        nameKey: "dungeon.types.silver_creek_crossing.blocks.silver_crossing_03.name",
        level: 22,
        size: 2,
        depth: 3,
        chest: 'normal',
        type: 'silver-creek-crossing',
        bossFloors: mkBossFloors([22,30])
      },
      {
        key: 'painted_switchbacks_03',
        name: 'Painted Switchbacks III',
        nameKey: "dungeon.types.painted_switchbacks.blocks.painted_switchbacks_03.name",
        level: 29,
        size: 3,
        depth: 4,
        chest: 'more',
        type: 'painted-switchbacks',
        bossFloors: mkBossFloors([28,34])
      },
      {
        key: 'coyote_den_03',
        name: 'Coyote Den III',
        nameKey: "dungeon.types.coyote_den_network.blocks.coyote_den_03.name",
        level: 18,
        size: 2,
        depth: 3,
        chest: 'normal',
        type: 'coyote-den-network',
        bossFloors: mkBossFloors([20,26])
      },
    ]
  };
